...
/** 半成品工序计件 */
public class ProduceHalfCount {

	private int id;
	private int produceDailyId;// 半成品子加工单id
	private int stationId; // 机台工位id
	private int userId;// 操作工id
	private int produceNum;// 生产数量
	private int successNum;// 合格品数量

	public ProduceHalfCount() {
	}

	public ProduceHalfCount(int produceDailyId, int stationId, int userId, int produceNum, int successNum) {
